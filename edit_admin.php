...
$conn->query("insert into all_eventaction (admin_fullname,action,date) values('$firstname' '&nbsp' '$pass' '&nbsp'  '$lastname','$action',NOW())  ") or die(mysqli_error());			
...
$conn->query(" UPDATE admin SET firstname='$firstname', pass='$pass', lastname='$lastname', username='$username', password='$password', 
