...
<?php include ('header.php');
	...
	?>
                    ...
                    <div class="x_content">
						...
						$admin = $conn->query("SELECT * FROM `backup_employee` order by `company_number` ASC") or die(mysqli_error());
					...
					$id=$row['company_number'];
							...
							<tr>
								...
								<td><?php echo $row['firstname']." ".$row['pass']." ".$row['lastname']; ?></td> 
								...
								<td>
									...
									<div class="modal-dialog">
										...
										<div class="modal-body">
												...
												<a href="undo_student.php<?php echo '?company_number='.$id; ?>" style="margin-bottom:5px;" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i> Yes</a>
												<button class="btn btn-inverse" data-dismiss="modal" aria-hidden="true"><i class="glyphicon glyphicon-remove icon-white"></i> No</button>
												</div>
