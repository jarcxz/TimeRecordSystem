...
<?php include ('header.php');
	...
	?>
                    ...
                    <div class="x_title">
                       ...
                       <h3><i class="fa fa-users"></i> Trainee's Information</h3><button  data-toggle="modal" data-target="#admin_modal" type="submit" name="submit" class="btn btn-danger"><i class="fa fa-plus-delete"></i> Delete All trainee Logs from recycle Bin</button></center>
                    ...
                    <div class="x_content">
						...
						$admin = $conn->query("SELECT * FROM `backup_login_logs` order by `company_number` ASC") or die(mysqli_error());
					...
					$id=$row['company_number'];
							...
							<tr>
								...
								<td>
									<a title ="Move trainee"  for="ViewAdmin"  href="#undo<?php echo'?company_number='.$id;  ?>" data-toggle="modal" data-target="#undo<?php echo $id;?>">
									...
									<a title="Delete Trainee" href="#delete<?php echo '?company_number='.$id;?>" data-toggle="modal" data-target="#delete<?php echo $id;?>">
									...
									<div class="modal-dialog">
										...
										<div class="modal-body">
												...
												<a href="delete_recycle_student.php<?php echo '?company_number='.$id; ?>" style="margin-bottom:5px;" class="btn btn-primary"><i class="glyphicon glyphicon-ok icon-white"></i> Yes</a>
...
<form action="deleteall_recyclelogs.php" method="post" enctype="multipart/form-data" class="form-horizontal form-label-left">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    <div class="x_title">
                        <center><h4><i class="fa fa-delete"></i>Delete all Trainee Logs permanently from Recycle Bin</h4></center>
